...
define('DB',getenv('PHPEMS_DB_NAME'));//MYSQL数据库名
define('DH',getenv('PHPEMS_DB_HOST'));//MYSQL主机名，不用改
define('DU',getenv('PHPEMS_DB_USER'));//MYSQL数据库用户名
define('DP',getenv('PHPEMS_DB_PASS'));//MYSQL数据库用户密码
